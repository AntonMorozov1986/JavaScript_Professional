<template>
  <div class="goods-item">
    <img class="goods-item-img" :src="'https://picsum.photos/id/' + checkedProduct.id + '/200/200'" :alt="checkedProduct.title" height="200" width="200">
    <h3 class="goods-item-title">{{ checkedProduct.title }}</h3>
